...
---
icon: i-lucide-star
to: https://nuxt.com/docs/3.x/guide/going-further/experimental-features#inlinerouterules
---
...
---
icon: i-lucide-medal
to: https://nuxt.com/docs/3.x/guide/concepts/rendering#hybrid-rendering
---
