...
::read-more
---
to: https://nuxt.com/docs/3.x/guide/going-further/internals#the-nuxtapp-interface
---
...
::read-more
---
to: https://nuxt.com/docs/3.x/directory-structure/plugins#providing-helpers
---
